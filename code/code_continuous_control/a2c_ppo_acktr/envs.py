...
from baselines.common.vec_env.dummy_vec_env import DummyVecEnv as ShmemVecEnv
# from baselines.common.vec_env.shmem_vec_env import ShmemVecEnv
from baselines.common.vec_env.vec_normalize import VecNormalize as VecNormalize_
from baselines.common.retro_wrappers import make_retro #, wrap_deepmind_retro

from code_continuous_control.a2c_ppo_acktr.stable_baselines.base_vec_env import VecEnvWrapper
from code_continuous_control.a2c_ppo_acktr.stable_baselines.running_mean_std import RunningMeanStd
...
def make_vec_envs(env_name,
    ...
    if len(envs) > 1:
        envs = ShmemVecEnv(envs)  #, context='fork'   not sure why I have this bug about 'fork'
    else:
