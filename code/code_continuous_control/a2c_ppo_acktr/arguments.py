...
def get_args():
    ...
    parser.add_argument(
        ...
        help='number of polices in the ensemble (default: 5)')
    parser.add_argument(
        '--ensemble_shuffle_type',
        choices=['no_shuffle', 'norm_shuffle','bootstrap','enhance_sample','dynamic_enhance_sample','enhance_bootstrap'],
        default='norm_shuffle') 
    parser.add_argument(
        '--behavior_cloning', default=True, action='store_true',
    ...
    parser.add_argument(
        ...
        default='cuda:0') 
    parser.add_argument(
        '--rounds', type=int, default=20, help='learning rounds in total (default: 50')
    parser.add_argument(
        '--data_per_round', type=int, default=50, help='new data per learning round (default: 50')
    parser.add_argument(
        '--use_log_loss', default=False, 
        help='use log loss for training (default: False)')
    parser.add_argument(
        '--lr', type=float, default=2.5e-4, help='behavior cloning learning rate (default: 2.5e-4)')
    parser.add_argument(
        '--batch_size', type=int, default=100, help='behavior cloning batch size (default: 100')#500  #200
    parser.add_argument(
        '--train_epoch', type=int, default=2000, help='behavior cloning training epochs (default=500)') #2001  2000
    parser.add_argument(
        '--non_realizable', default=False, 
        help='let the lerner to perform badly (default: False)')
    parser.add_argument(
        '--linear', default=False, 
        help='use linear model without activations (default: False)')
    parser.add_argument(
        '--random_selection', default=True, 
        help='use random list to choose from esnsembles or use average(default: True)')
    parser.add_argument(
        '--noisy_expert', default=False, 
        help='use expert with gaussian noise (default: False)')
    parser.add_argument(
        '--offline_rounds', type=int, default=-1, help='offline expert sample ratio default 2,4,8')
    ...
    parser.add_argument(
        '--gail-lr', type=float, default=7e-4, help='learning rate (default: 7e-4)')
    parser.add_argument(
        '--eps',
        type=float,
        default=1e-5,
    ...
    parser.add_argument(
        ...
        type=int,
        default=25,
        help='how many evaluation CPU processes to use (default: 16)')
    parser.add_argument(
        '--num-steps',
        type=int,
        default=5,
